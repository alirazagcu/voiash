    ...
    <TableContainer component={Paper} className={classes.table1}>
      <Table size="small" className={classes.table} aria-label="custom pagination table">
        ...
        <TableRow >
           ...
           <div align="right"><Link to="/admin/users/new"><Button variant="primary" >Nuevo</Button></Link></div>  
              </TableCell>
            </TableRow>
          {(rowsPerPage > 0
           ...
           <TableRow  key={row.name}>
              ...
              <Link to="/admin/users/update" className="linker">
                <div className="tablelink"><p className="tabeltext">akashanjum282@gmail.com</p></div>
              </Link>
              </TableCell>
            </TableRow>
          ))}
