        ...
        <div className="adminPersonal">
            <div className="adminpersonalnavbar">
                <div className="adminpersonaldiv">
                    <div><NavLink to="/admin"  className="linkss2" ><HouseIcon className="adminicon" />Overview</NavLink></div>
                    <div><NavLink to="/admin/families" className="linkss2" ><LayersIcon className="adminicon" />Familias</NavLink></div>
                    <div><NavLink to="/admin/groups" className="linkss2" ><GroupIcon className="adminicon" />Grupos</NavLink></div>
                    <div><NavLink to="/admin/experiences" className="linkss2" ><WorkIcon className="adminicon" />Experiencias</NavLink></div>
                    <div><NavLink to="/admin/hotels" className="linkss2" ><HotelIcon className="adminicon" />Hoteles</NavLink></div>
                    <div><NavLink to="/admin/destinations" className="linkss2" ><LocationOnIcon className="adminicon" />Destinos</NavLink></div>
                    <div><NavLink to="/admin/insurances" className="linkss2" >< VerifiedUserIcon className="adminicon"/>Seguros</NavLink></div>
                    <div><NavLink to="/admin/users" className="linkss2" ><PersonIcon className="adminicon" />Usuarios</NavLink></div>
                    <div><NavLink to="/admin/localfriends" className="linkss2" ><SportsKabaddiIcon className="adminicon" />Local Friends</NavLink></div>
                    <div><NavLink to="/admin/reservations" className="linkss2" ><TurnedInIcon className="adminicon" />Reservaciones</NavLink></div>
                    <div><NavLink to="/admin/payments" className="linkss2" ><PaymentIcon className="adminicon"/>Pagos</NavLink></div>
                    <div><NavLink to="/admin/fees" className="linkss2" ><PaymentIcon className="adminicon"/>Comisiones</NavLink></div>
                </div>    
            </div>
            ...
            <div className="adminpersonalform">
                <Switch>
                    ...
                    {/* //update */}
                    <Route exact path="/admin/families/update" component={FamiliesUpdate} />
                    ...
                    <Route exact path="/admin/destinations/update" component={DestinationsUpdate} />
                    <Route exact path="/admin/destinations/new" component={DestinationsNew} />
                    <Route exact path="/admin/insurances/update" component={InsurancesUpdate} />
                    <Route exact path="/admin/insurances/new" component={InsurancesNew} />
                    ...
                    <Route exact path="/admin/localfriends/update" component={LocalfriendsUpdate} />
                    <Route exact path="/admin/localfriends/new" component={LocalfriendsNew} />
                    <Route exact path="/admin/payments/update" component={PaymentsUpdate} />
                    <Route exact path="/admin/fees/new" component={FeeNew} />
                    <Route exact path="/admin/fees/update" component={FeeUpdate} />
                    <Route exact path="/admin/reservations/update" component={ReservationUpdate} />
                    <Route exact path="/admin/reservations/new" component={ReservationsNew} />
                    <Route exact path="/admin/experiences/update" component={ExperiencesUpdate} />
                    <Route exact path="/admin/experiences/new" component={ExperiencesNew} />
                </Switch>
            </div>
        </div> 
    );
