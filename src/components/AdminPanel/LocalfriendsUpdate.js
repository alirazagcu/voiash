                ...
                <Form >
                    ...
                    <Row className="rowmarn">
                        ...
                        <Col >
                            ...
                            <Form.Control defaultValue="Angel Calderaro" />
                        </Col >
                        <Col >
                            <Form.Label>Edad</Form.Label>
                            <Form.Control defaultValue="35" />
                        </Col>
                    </Row>
                    <Row className="rowmarn">
                        <Col xs={6}>
                    ...
                    <Row className="rowmarn">
                        <Col >
                            ...
                            <Form.Control defaultValue="648202569O" />
                        </Col >
                        <Col >
                    ...
                    <Row className="rowmarn">
                                <Col>
                                    ...
                                    <Form.Control  placeholder="PASEO SAN FRANCISCO DE SALES 23" />
                                </Col>
                            </Row>
                            <Row className="rowmarn">
                                <Col>
                                    <Form.Label>Acerca de ti</Form.Label>
                                    <Form.Control type="text" placeholder="Soy un tio divertido"  as="textarea" aria-label="With textarea"/>
                                </Col>
                            </Row>
                            <Row className="rowmarn">
                                        <Col >
                    ...
                    <Row className="rowmarn">
                        <Col >
                            ...
                            <Form.Control defaultValue="hostIdentificacións/iPpyFyV61ON9VyBQPREgsuPUP2g2/identification.jpg" />
                        </Col >
                    </Row>
