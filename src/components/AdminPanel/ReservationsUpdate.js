            ...
            <Form>
              ...
              <Row className="rowmarn">
                <Col>
                  ...
                  <Form.Control defaultValue="AMERICANO 2021" />
                </Col>
                <Col>
                  <Form.Label>Costo total</Form.Label>
                  <Form.Control defaultValue="22960.00 MXN" />
                </Col>
                <Col>
              ...
              <Row className="rowmarn">
                ...
                <Col>
                  ...
                  <Form.Control type="date" defaultValue="22959.00 MXN" />
                </Col>
              </Row>
              ...
              <Row className="rowmarn">
                <Col>
                  ...
                  <Form.Control defaultValue="Gabriel" />
                </Col>
                <Col>
                  <Form.Label>Apellido Pateron</Form.Label>
                  <Form.Control defaultValue="Cortez" />
                </Col>
                <Col>
              ...
              <Row className="rowmarn">
                <Col>
                  ...
                  <Form.Control type="date" defaultValue="02/28/2003" />
                </Col>
                <Col>
                  <Form.Label>Correo electrónico</Form.Label>
                  <Form.Control
                    type="email"
                    defaultValue="cortezg@asf.edu.mx"
                  />
                </Col>
                <Col>
                  <Form.Label>Teléfono principal</Form.Label>
                  <Form.Control defaultValue="5516649068" />
                </Col>
              </Row>
              <Row className="rowmarn">
                <Col>
                  <Form.Label>Teléfono secundario</Form.Label>
                  <Form.Control defaultValue="5541370007" />
                </Col>
              </Row>
              <Row className="rowmarn">
                <Col>
                    ...
                    {rows.map((row) => (
                      <TableRow key={row.name}>
                        ...
                        >
                          <Link to="/admin/payments/update" className="linker">
                            <div className="tablelink">
                              <p className="tabeltext">{row.carbs}</p>
                            </div>
                          </Link>
                        </TableCell>
                        <TableCell
                        ...
                        >
                          <Link to="/admin/payments/update" className="linker">
                            <div className="tablelink">
                              <p className="tabeltext">{row.protein}</p>
                            </div>
                          </Link>
                        </TableCell>
                      </TableRow>
