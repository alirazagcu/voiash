...
const rows = [
  createData('04/12/2020 10:04','Royalton Riviera Cancun', 'México', 'Cancún'),
  createData('04/12/2020 10:04','Royalton Riviera Cancun', 'México', 'Cancún'),
  createData('04/12/2020 10:04','Royalton Riviera Cancun', 'México', 'Cancún'),
  createData('04/12/2020 10:04','Royalton Riviera Cancun', 'México', 'Cancún'),
  createData('04/12/2020 10:04','Royalton Riviera Cancun', 'México', 'Cancún'),
      ...
      <Table size="small" className={classes.table} aria-label="custom pagination table">
        ...
        <TableRow >
            ...
            <div className="formcontrol"> <Form inline>
              ...
              <TableCell component="th" className="searchdiv" >
           <div align="right"><Link to="/admin/hotels/new"><Button variant="primary" >Nuevo</Button></Link></div>  
              </TableCell>
            </TableRow>
          {(rowsPerPage > 0
           ...
           <TableRow  key={row.name}>
              ...
              <Link to="/admin/hotels/update" className="linker">
