...
const rows = [
  createData('CARLOS BERNIER', "Aprobado"),
  createData('Adriana'),
  createData('Angel Calderaro', "Aprobado"),
    ...
    <TableContainer component={Paper} className={classes.table1}>
      <Table size="small" className={classes.table} aria-label="custom pagination table">
        ...
        <TableRow >
           ...
           <div align="right"><Link to="/admin/localfriends/new"><Button variant="primary" >Nuevo</Button></Link></div>  
              </TableCell>
            </TableRow>
          {(rowsPerPage > 0
           ...
           <TableRow  key={row.name}>
              ...
              <Link to="/admin/localfriends/update" className="linker">
              ...
              <TableCell  className="pakistan" component="th" scope="row">
              <Link to="/admin/localfriends/update" className="linker">
                <div className="tablelink"><p className="tabeltext">{row.calories}</p>
