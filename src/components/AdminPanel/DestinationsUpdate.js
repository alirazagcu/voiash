                ...
                <Card style={{ width: '23rem' }, { borderWidth: 3 }, { borderColor: 'rgb(238, 91, 46)' }}  >
                    <Card.Body>
                        ...
                        <Row className="rowmarn">
                                        ...
                                        <div className="firstbtn1"><Link  to="/admin/destinations"><Button>Volver</Button></Link></div>
                                    ...
                                    <Row className="rowmarn">
                                        ...
                                        <Form.Label>Nombre</Form.Label>
                                            <Form.Control defaultValue="PUERTO VALLARTA" />
                                        </Col >
                                    </Row>
                                    <Row className="rowmarn">
                                    <Col >
                                        <Form.Label>País</Form.Label>
                                            <Form.Control defaultValue="México" />
                                        </Col>
                                    </Row>
                                    <Row className="rowmarn">
                                    <Col >
