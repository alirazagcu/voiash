...
function InsurancesUpdate() {
  ...
  const { isError, isFetching, isSuccess, msg, insurance } = useSelector(
  ...
  const onDeleteHandler = () => {
    ...
    setIsDelete(true);
    dispatch(
      insuranceAction({ type: "delete", _id: stateValues._id, token: token })
    );
  };
          ...
          {/* <Row className="rowmarn">
            <Col className="image-upload12">
              ...
              <label for="file-input" className="newclass">
                <p className="paragrapinput">
                  insurances/QztTQC1NWZcoGFjfRNmd/file.pdf
                </p>
              </label>
