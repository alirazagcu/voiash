               ...
               <Row className="marginbootm">
                    ...
                    <Row className="rowmarn">
                        <Col >
                            ...
                            <Form.Control defaultValue="En este caso, se te devolverá todo el dinero a excepción del
10% de lo pagado en concepto de franquicia por parte de la compañía aseguradora.
Este seguro también incluye 31 causas por las cuales puedes cancelar tu viaje, si cancelas por uno
de estos motivos se te devolverá todo el dinero sin aplicarte ninguna franquicia.
Además, la cobertura médica en destino sube hasta 25.000€ " placeholder="State" as="textarea" aria-label="With textarea" />
                        </Col>
                    </Row>
                    <Row className="rowmarn">
                        <Col >
