                ...
                <Card style={{ width: '23rem' }, { borderWidth: 3 }, { borderColor: 'rgb(238, 91, 46)' }}  >
                    <Card.Body>
                        ...
                        <Row className="rowmarn">
                                        ...
                                        <div className="firstbtn1"><Link to="/profile/localfriend/experiences"><Button>Volver</Button></Link></div>
                                ...
                                <TableBody>
                                    ...
                                    <Col >
                                        <Form.Label>Descripción Corta</Form.Label>
                                            <Form.Control defaultValue="¡The City Cancún ofrece la mejor fiesta de la ciudad!  Reservando la opción de barra libre no sólo tendrás acceso a la disco más grande de Latinoamérica sino que podrás disfrutar de bebidas nacionales ilimitadas.
WE OWN THE NIGHT!" as="textarea" aria-label="With textarea"/>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col >
