        ...
        <Router>
            ...
            <div className="comp">
                ...
                <Route exact path="/forget" component={Forget}/>
                    ...
                    <Route exact path="/profile/information/personal" component={Profile} />
                    <Route exact path="/profile/information/location" component={Profile} />
                    <Route exact path="/profile/information/contact" component={Profile} />
                    <Route exact path="/profile/information/payment-methods" component={Profile} />
                    <Route exact path="/profile/information/payments" component={Profile}/>
                    <Route exact path="/profile/reservations/groups" component={Profile} />
                    <Route exact path="/profile/reservations/experiences" component={Profile} />

                    <Route exact path="/profile/localfriend/data" component={Profile} />
                    <Route exact path="/profile/localfriend/experiences" component={Profile} />
                    <Route exact path="/profile/localfriend/reservations" component={Profile} />
                    <Route exact path="/selection" component={Selection}/>
                    <Route exact path="/profile/reservations/groups/details" component={Profile} />
                    <Route exact path="/profile/localfriend/experiences/update" component={Profile} />
                    <Route exact path="/profile/localfriend/experiences/new" component={Profile} />
